...
import com.smartshop.demo.security.JwtAuthFilter;
import com.smartshop.demo.security.OAuth2AuthenticationFailureHandler;
import com.smartshop.demo.security.OAuth2AuthenticationSuccessHandler;
import com.smartshop.demo.security.RateLimitFilter;
import com.smartshop.demo.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/admin/flash-sales", "/api/admin/flash-sales/**").hasAnyRole("ADMIN", "STAFF")
